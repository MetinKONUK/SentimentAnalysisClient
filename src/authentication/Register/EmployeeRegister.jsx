...
function EmployeeRegister() {
  ...
  const handleSubmit = async (event) => {
    ...
    const data = {
      moventName: moventData['employee-firstname'],
      moventLastname: moventData['employee-lastname'],
      moventAge: moventData['employee-age'],
      moventPhoneNumber: moventData['employee-phone-number'],
  ...
  return (
    ...
    >
      ...
      <Box component="form" noValidate onSubmit={handleSubmit} sx={{ mt: 1 }}>
        ...
        />
        <TextField
          name="employee-letter-of-request"
          id="employee-letter-of-request"
